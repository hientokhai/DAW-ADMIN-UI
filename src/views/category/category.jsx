                ...
                <tbody>
                    {categories.map(category => (
                        <tr key={category.id}>
                            ...
                            <td>
                                <Button variant="warning" onClick={() => handleShow(category)}>Sửa</Button>
...
const SizeManagement = () => {
    ...
    return (
        <div>
            <h2>Quản lý Size</h2>
            <Button variant="primary" onClick={handleShowAddSize}>Thêm Size</Button>
            <Table striped bordered hover>
                <thead>
                    <tr>
                        <th>ID</th>
                ...
                <tbody>
                    {sizes.map(size => (
                        <tr key={size.id}>
                            ...
                            <td>{size.name}</td>
                            <td>
                                <Button variant="warning" onClick={() => handleShowSize(size)}>Sửa</Button>
                                <Button variant="danger" onClick={() => handleDeleteSize(size.id)}>Xóa</Button>
                            </td>
                        </tr>
                    ))}
                </tbody>
...
const ColorManagement = () => {
    ...
    return (
        <div>
            ...
            <Button variant="primary" onClick={handleShowAddColor}>Thêm Màu sắc</Button>
            <Table striped bordered hover>
                <thead>
                    <tr>
                        <th>ID</th>
                ...
                <tbody>
                    {colors.map(color => (
                        <tr key={color.id}>
                            ...
                            <td>{color.name}</td>
                            <td>
                                <Button variant="warning" onClick={() => handleShowColor(color)}>Sửa</Button>
                                <Button variant="danger" onClick={() => handleDeleteColor(color.id)}>Xóa</Button>
                            </td>
                        </tr>
                    ))}
                </tbody>
